const { TestnetContract, testnetWallet } = require("../../Config/Config");
  ...
  const t = await ContractInstance.usdtBsc.methods
    ...
    .call((error, result) => {
      if (error) {
        ...
        const balance = result / 10 ** 18; // USDT has 8 decimal places, so divide by 10**18 to get the balance in USDT
